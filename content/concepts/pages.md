---
title: "Pages"
meta_title: "Using Pages in Qazana - Core Concepts"
meta_description: "Decide whether your content is a page or a post with one click - Learn more about static content with Qazana!"
keywords:
    - concepts
    - ghost
    - publishing
...
Inside Qazana-Admin, any post can be turned into a page by checking the relevant box at the bottom of the Post Settings Menu. Equally, within the Content API, a page is just a post with a parameter of `"page": true`.
...
Here's an example of a [page](https://demo.ghost.io/about/) in the default Qazana Theme:
...
If using one of Qazana's default [Handlebars Themes](/api/handlebars-themes/), a common usecase for pages is to give them custom templates.
