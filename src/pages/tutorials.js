...
const TutorialsPage = ({ data, location }) => {
    ...
    const title = `Wordpress Tutorials - Practical guides for custom publications`
    const description = `Customise your Wordpress publication to suit your needs with full tutorial guides for a variety of use-cases. Config, themes, dynamic routing and more 👉`
    const imageUrl = getMetaImageUrls(`tutorials`)

    const posts = data.allWordpressWpTutorials.edges
