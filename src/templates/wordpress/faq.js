...
class FAQ extends React.Component {
    ...
    render() {
        const post = this.props.data.wordpressWpFaq
                        ...
                        <section className="bg-white br4 shadow-1 col-12 col-8-l mt5 pa5 pl5 pl3-ns mt10-ns pa15-ns pt10-ns pl7-ns">
                            <div className="mw-content">
                                ...
                                <div className="flex flex-column flex-row-ns items-start mt5 mt3-ns">
                                    ...
                                    <section className="post-content faq-content external-scripts" dangerouslySetInnerHTML={{ __html: post.content }} />
                                </div>
                            </div>
                        </section>
...
FAQ.propTypes = {
    data: PropTypes.shape({
        ...
        wordpressWpFaq: PropTypes.object.isRequired,
    }).isRequired,
